...
const Home = (props) => {
  return (
    <div className="home-container">
      <Helmet>
        <title>Several Ringed Oryx</title>
        <meta property="og:title" content="Several Ringed Oryx" />
      </Helmet>
      <div className="home-header">
        ...
        >
          <span className="logo">TEXTILE</span>
          ...
          <div className="home-container1">
            ...
            <span className="home-hero-sub-heading bodyLarge">
              <span>
                <span>
                  <span>
                    Connecting textile manufacturers with top sales
                    representatives
                  </span>
                  <span>
                    <span
        ...
        <div className="featuresContainer">
          <div className="home-features1">
            ...
            <div className="home-container3">
              <FeatureCard
                heading="Wide Range of Textile Products"
                subHeading="Representing a diverse selection of high-quality textiles for various industries"
              ></FeatureCard>
              <FeatureCard
                heading="Expert Consultation Services"
                subHeading="Providing personalized guidance and advice on textile solutions for clients"
              ></FeatureCard>
              <FeatureCard
                heading="Efficient Order Processing"
                subHeading="Streamlined processes for quick and accurate order fulfillment"
              ></FeatureCard>
              <FeatureCard
                heading="Responsive Customer Support"
                subHeading="Dedicated team ready to assist with inquiries and support needs"
              ></FeatureCard>
            </div>
          </div>
        </div>
        ...
        <div className="faqContainer">
          <div className="home-faq1">
            ...
            <div className="home-container5">
              <Question1
                answer="We represent a wide range of textiles including cotton, silk, wool, and synthetic fibers."
                question="What types of textiles do you represent?"
              ></Question1>
              <Question1
                answer="You can contact a textile rep by filling out the contact form on our website or by calling our customer service hotline."
                question="How can I contact a textile rep?"
              ></Question1>
              <Question1
                answer="Yes, we offer samples of our textiles for potential clients to review and test before making a purchase."
                question="Do you offer samples of your textiles?"
              ></Question1>
              <Question1
                answer="The typical lead time for orders varies depending on the quantity and type of textiles ordered. Our reps can provide more specific information based on your needs."
                question="What is the typical lead time for orders?"
              ></Question1>
              <Question1
                answer="Yes, we work with both domestic and international clients to provide quality textiles and services worldwide."
